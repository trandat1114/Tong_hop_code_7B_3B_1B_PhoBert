...
7. [Theo dõi training](#7-theo-dõi-training)
8. [Inference](#8-inference)
9. [Kết quả thực nghiệm](#9-kết-quả-thực-nghiệm)
10. [Cấu hình chi tiết](#10-cấu-hình-chi-tiết)
...
│   └── train_llm_lora.py      # Fine-tune Qwen2.5 1.5B/3B/7B (LoRA)
│
├── inference/
